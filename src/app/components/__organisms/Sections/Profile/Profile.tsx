  ...
  return (
    <>
      ...
      <div className="flex justify-between w-full container max-w-[1128px] mt-6">
        ...
        <div
          className={`${DarkMode ? "bg-[#1b1e22] text-white" : "bg-[#fefeff] text-black"} ml-5 max-[790px]:hidden flex flex-col gap-2 w-[300px] rounded-[10px] px-4 py-4 shadow-[0px_0px_0px_1px_rgb(140_140_140_/_0.2)]`}
        >
