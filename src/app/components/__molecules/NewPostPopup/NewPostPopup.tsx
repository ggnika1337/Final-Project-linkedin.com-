        ...
        >
          ...
          <div className="pl-[24px] min-h-[150px] w-full h-full relative">
            <textarea
              ...
              className="focus:outline-none w-full h-full transition-none bg- min-h-[200px] max-h-[400px]"
            />
            <div
          ...
          <div className="px-[24px] max-md:px-[10px] flex active:outline-none">
            <button
              ...
              className="rounded-[15px] whitespace-nowrap flex items-center justify-center gap-1 text-[13px] border-1 border-black px-2 cursor-pointer hover:bg-[#8080802f]"
            >
              <svg
                width={16}
                height={16}
          ...
          <div className="px-[24px] flex items-end justify-end">
            <button
              className={`rounded-[15px] px-[10px] text-[14px] py-0.5 ${text.length > 0 ? "bg-[#0b67c2] text-white cursor-pointer " : "bg-[#e8e8e8] cursor-not-allowed text-[#aeafae]"}`}
            >
              Post
            </button>
          </div>
