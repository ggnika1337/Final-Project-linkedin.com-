  ...
  return (
    <>
      <div className="ml-7 w-full max-[830px]:ml-0">
        ...
        >
          <div
            className={`${popup ? "opacity-100 translate-y-[-100px] pointer-events-auto" : "opacity-0 translate-y-[-0px] pointer-events-none"} w-full flex items-center justify-center`}
          >
            <NewPostPopup
              mediaRef={mediaRef}
