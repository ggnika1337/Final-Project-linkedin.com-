...
function Left() {
  ...
  return (
    <>
      <div className="flex flex-col gap-2 z-1 max-w-[216px] max-[830px]:max-w-[100%] w-full whitespace-nowrap">
        <ProfileCard />
        <PremiumOffer />
        <div
          className={`${DarkMode ? "text-white bg-[#1b1e22]" : "text-black bg-[#fefeff]"} rounded-[10px] px-5 py-2 flex flex-col relative shadow-[0px_0px_0px_1px_rgb(140_140_140_/_0.2)]`}
        >
